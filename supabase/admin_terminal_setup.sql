-- ============================================================
-- Admin Terminal Setup SQL
-- Run this in Supabase SQL Editor
-- ============================================================

-- 1. Failed admin access logs table
-- Stores every failed passkey attempt for security auditing
...
-- RLS: Any authenticated user can INSERT (to log their own failed attempts)
-- Only admins can SELECT (to review logs)
...
-- 2. Ensure app_settings has the app_shutdown column (idempotent)
ALTER TABLE public.app_settings
  ADD COLUMN IF NOT EXISTS app_shutdown BOOLEAN DEFAULT FALSE;

-- 3. Ensure app_settings default row exists
